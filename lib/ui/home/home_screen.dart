...
import 'package:portfolio_master/ui/home/info_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(flex: 4, child: _buildTabImage())
                    ],
                  ),
                )
              ],
        ...
        child: MouseRegion(
            ...
            child: AnimatedScale(
              ...
              child: Container(
                decoration: BoxDecoration(
                    color:
                        _socialSelected == social ? hoverColor : defaultColor,
                  ...
                  Flexible(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            TextEx(Constant.mine.title, size: 26),
                            SizedBox(width: 8,),
                            Image.asset(
                              icAndroid.fromAssets(),
                              width: 36,
                              height: 36,
                            ),
                          ],
                        ...
                        TextEx("(Native Java/Kotlin, Jetpack Compose, Flutter)", size: 26),
                        const SizedBox(
                          height: 40,
                        ),
                        Flexible(
  ...
  Widget _buildAlignAndroidLottieFile() {
    return Align(
      ...
      child:
          Lottie.asset(LottieFilesAsset.android, controller: _lottieController),
    );
  }
        ...
        child: MouseRegion(
            ...
            child: AnimatedScale(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: _buildImageSwitcher(_socialSelected),
                ))));
  }
